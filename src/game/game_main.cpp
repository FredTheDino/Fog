...
void setup() {
    ...
    {
        f32 filter_coeffs[] = {
            -0.448093,  0.322875,   0.181163,   0.087615,   0.056797,
             0.086685,  0.148049,   0.187190,   0.151019,   0.027594,
            -0.132676, -0.232561,  -0.187804,   0.006382,   0.250536,
             0.387214,  0.299817,   0.002609,  -0.345546,  -0.525282,
            -0.395620,  0.000246,   0.440998,   0.651867,   0.479110,
             0.000135, -0.508558,  -0.736313,  -0.529380,  -0.000709,
             0.540186,  0.766746,   0.540186,  -0.000709,  -0.529380,
            -0.736313, -0.508558,   0.000135,   0.479110,   0.651867,
             0.440998,  0.000246,  -0.395620,  -0.525282,  -0.345546,
             0.002609,  0.299817,   0.387214,   0.250536,   0.006382,
            -0.187804, -0.232561,  -0.132676,   0.027594,   0.151019,
             0.187190,  0.148049,   0.086685,   0.056797,   0.087615,
             0.181163,  0.322875,  -0.448093
        };
        channel->set_lowpass(filter_coeffs, LEN(filter_coeffs));
    }
}
