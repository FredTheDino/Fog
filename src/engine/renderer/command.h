...
void push_quad(Vec2 min, Vec2 min_uv, Vec2 max, Vec2 max_uv, int sprite,
                      Vec4 color = V4(1, 1, 1, 1));

// Queues up a quad to render to the screen, ignoring texture coordinates.
void push_quad(Vec2 min, Vec2 max, Vec4 color = V4(1, 1, 1, 1));
...
void push_rectangle(Vec2 position, Vec2 dimension, Vec4 color=V4(1, 1, 1, 1));
...
void push_point(Vec2 point, Vec4 color, f32 size = 0.015);
